        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            @foreach($table as $datas)
                <tr>
                    ...
                    <td><img class="img-thumbnail" src="{{asset('UploadedFile/berita/'.$datas->attachment)}}" alt="Photo" width="100"></td>
                    <td>
                        <a href="*" id="{{$datas->id}}" class="btn bg-gradient-warning edit">Edit</a>
                        |
                        <a href="#" id="{{$datas->id}}" class="btn bg-gradient-danger delete" data-action="{{asset('ajax/berita/delete')}}">Hapus</a>
                    </td>
