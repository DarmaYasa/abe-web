...
@section('titlecontent','Pengumuman')
@section('breadcrumb')
    <li class="breadcrumb-item active">Pengumuman</li>
@endsection
@section('content')
    <form role="form" action="/ajax/pengumuman/create" method="post" id="form-send" enctype="multipart/form-data">
        @csrf
    ...
    <form role="form" action="/ajax/pengumuman/update" method="post" id="form-update" enctype="multipart/form-data">
        @csrf
