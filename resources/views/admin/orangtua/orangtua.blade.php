...
@section('titlecontent','Data Orang Tua')
@section('breadcrumb')
    <li class="breadcrumb-item active">Data</li>
    <li class="breadcrumb-item active">Orang Tua</li>
@endsection
@section('content')
    <form role="form" action="/ajax/orangtua/create" method="POST" id="form-send">
        @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"  placeholder="Nama" name="nama_orangtua">
                            </div>
                            <div class="form-group">
    ...
    <form role="form" action="/ajax/orangtua/update" method="post" id="form-update">
        @csrf
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Nama</label>
                                <input type="text" class="form-control"  placeholder="Nama" name="nama_orangtua" id="nama">
                            </div>
                            <div class="form-group">
                                <label>Kelamin</label>
                                <div>
